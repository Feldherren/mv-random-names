...
(function() {
 ...
 Game_Enemy.prototype.setup = function(enemyId, x, y) {
 	...
 	if (enemy.meta.name_list)
 	{
 		name_set = parameters[enemy.meta.name_list].split(parameters['Separator']);
 	}
 	else if (enemy.meta.random_names)
 	{
 		name_set = enemy.meta.random_names.split(parameters['Separator']);
 	}
 	else
 	{
 		name_set = [this.name];
